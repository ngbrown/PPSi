...
#define PP_DEFAULT_AI				250
#define PP_DEFAULT_DELAY_S			6
#define PP_DEFAULT_ANNOUNCE_INTERVAL		3	/* 0 in 802.1AS */
...
#define PP_DEFAULT_SYNC_INTERVAL		1	/* -7 in 802.1AS */
...
#define PP_DEFAULT_NEXT_DELAY_MS	100
